...
async def answer_question12(message: types.Message, state: dict):
    ...
    await message.answer(
        '13. Какие преимущества получает менеджер по продажам, если с нужным человеком его'
...
async def answer_question15(message: types.Message, state: dict):
    ...
    await message.answer(
        '16. Сочетание каких качеств менеджера по продажам важны на этапе выстраивания '
        'партнерских взаимоотношений с клиентом?\n\n'
        ...
        '3. <i>Понимание специфики бизнеса,умение руководить,умение совершать сделки</i>\n'
